...
public class Gauge extends SimpleCollector<Gauge.Child> implements Collector.Describable {
  ...
  public List<Collector.MetricFamilySamples> collect() {
    ...
    return familySamplesList(Collector.Type.GAUGE, samples);
  }

  @Override
  public List<Collector.MetricFamilySamples> describe() {
    return Collections.<Collector.MetricFamilySamples>singletonList(new GaugeMetricFamily(fullname, help, labelNames));
  }
